               ...
               double &stpTry, int &objCnt, fcndata &fcnObj)
{
	...
	{
		mexPrintf("\n");
		mexPrintf("Not a descent direction.\n");
		mexPrintf("Quit BFGS.\n");
		mexPrintf("\n");
		return 1;
	}
	...
	{
		mexPrintf("\n");
		mexPrintf("Line search failed to bracket a point satisfying weak Wolfe conditions.\n");
		mexPrintf("Function may be unbounded below.\n");
		mexPrintf("Quit BFGS.\n");
		mexPrintf("\n");
		return 2;
	}
	...
	mexPrintf("\n");
	mexPrintf("Line search failed to satisfy weak Wolfe conditions, although\n");
	mexPrintf("a point satisfying conditions was bracketed in [%e, %e].\n", relLft, relRgt);
	mexPrintf("Quit BFGS.\n");
	mexPrintf("\n");
	return 3;
}
